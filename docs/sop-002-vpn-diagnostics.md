...
3. Right-click the virtual VPN adapter (e.g., *Cisco AnyConnect Virtual Adapter* or *Palo Alto GlobalProtect Adapter*) and select **Uninstall device**.
4. Select **Action** from the top menu > click **Scan for hardware changes** to force the operating system to reinstall the driver.
